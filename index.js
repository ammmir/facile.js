...
(function() {
  var bindArray, bindAttributeObject, bindData, bindNestedObject, bindObject, bindOrRemove, bindValue, facile, find, fs, setAttributeValue, startProcessing, tagName, _render, _templateCache;
  ...
  if (typeof module !== "undefined" && module !== null ? module.exports : void 0) {
    ...
    _templateCache = {};
    _render = function(template, locals, cb) {
      var html;
      try {
    ...
    facile.__express = function(path, options, callback) {
      if ('production' === options.settings.env) {
        if (_templateCache[path]) {
          return _render(_templateCache[path], options, callback);
        } else {
        ...
        return fs.readFile(path, function(err, data) {
          ...
          return _render(data.toString(), options, callback);
        });
      }
    };
    facile.clearCache = function() {
